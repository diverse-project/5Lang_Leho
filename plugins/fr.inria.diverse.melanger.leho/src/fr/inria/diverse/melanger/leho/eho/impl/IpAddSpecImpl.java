 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.melanger.leho.eho.impl.IpAddSpecImpl#getAdress <em>Adress</em>}</li>
 *   <li>{@link fr.inria.diverse.melanger.leho.eho.impl.IpAddSpecImpl#getPort <em>Port</em>}</li>
 *   <li>{@link fr.inria.diverse.melanger.leho.eho.impl.IpAddSpecImpl#getMask <em>Mask</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IpAddSpecImpl extends EObjectImpl implements IpAddSpec {
	...
	protected EClass eStaticClass() {
		return EhoPackage.Literals.IP_ADD_SPEC;
	}
	...
	public void setAdress(String newAdress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EhoPackage.IP_ADD_SPEC__ADRESS, oldAdress, adress));
	}
	...
	public void setPort(String newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EhoPackage.IP_ADD_SPEC__PORT, oldPort, port));
	}
	...
	public void setMask(int newMask) {
		...
		mask = newMask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EhoPackage.IP_ADD_SPEC__MASK, oldMask, mask));
	}
	 ...
	 */
	@Override
	public Boolean eval(Policy root, Boolean type) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EhoPackage.IP_ADD_SPEC__ADRESS:
				return getAdress();
			case EhoPackage.IP_ADD_SPEC__PORT:
				return getPort();
			case EhoPackage.IP_ADD_SPEC__MASK:
				return getMask();
		}
