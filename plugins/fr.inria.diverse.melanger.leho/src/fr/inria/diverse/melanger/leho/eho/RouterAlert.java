 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.melanger.leho.eho.RouterAlert#getProtocol <em>Protocol</em>}</li>
 * </ul>
 *
 * @see fr.inria.diverse.melanger.leho.eho.EhoPackage#getRouterAlert()
 * @model
 * @generated
 */
public interface RouterAlert extends OptionHopByHop {
	 ...
	 * The list contents are of type {@link fr.inria.diverse.melanger.leho.eho.Protocol}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Protocol</em>' containment reference list.
	 * @see fr.inria.diverse.melanger.leho.eho.EhoPackage#getRouterAlert_Protocol()
