 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.melanger.leho.eho.impl.HopByHopOptsImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HopByHopOptsImpl extends ExtensionHeaderImpl implements HopByHopOpts {
	...
	protected EClass eStaticClass() {
		return EhoPackage.Literals.HOP_BY_HOP_OPTS;
	}
	...
	public EList<OptionHopByHop> getOptions() {
		if (options == null) {
			options = new EObjectContainmentEList<OptionHopByHop>(OptionHopByHop.class, this, EhoPackage.HOP_BY_HOP_OPTS__OPTIONS);
		}
		return options;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EhoPackage.HOP_BY_HOP_OPTS__OPTIONS:
